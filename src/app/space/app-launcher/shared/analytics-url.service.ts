...
export let ANALYTICS_RECOMMENDER_URL = new InjectionToken('analytics.recommender.url');
export let ANALYTICS_LICENSE_URL = new InjectionToken('analytics.license.url');
