...
export const currentContext: Context = {
  ...
  space: {
    ...
    links: {
      ...
      workitemlinktypes:
        'https://api.prod-preview.openshift.io/api/spaces/1d7af8bf-0346-432d-9096-4e2b59d2db87/workitemlinktypes',
      workitemtypes:
        'https://api.prod-preview.openshift.io/api/spaces/1d7af8bf-0346-432d-9096-4e2b59d2db87/workitemtypes',
    },
    relationships: {
      areas: {
        links: {
          related:
            'https://api.prod-preview.openshift.io/api/spaces/1d7af8bf-0346-432d-9096-4e2b59d2db87/areas',
        },
      },
      iterations: {
        links: {
          related:
            'https://api.prod-preview.openshift.io/api/spaces/1d7af8bf-0346-432d-9096-4e2b59d2db87/iterations',
        },
      },
      workitemtypegroups: {
        links: {
...
export const expectedGitHubRepo: GitHubRepo = {
  ...
  collaborators_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/collaborators{/collaborator}',
  ...
  issue_events_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/issues/events{/number}',
  ...
  issue_comment_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/issues/comments{/number}',
  ...
  notifications_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/notifications{?since,all,participating}',
...
export const expectedGitHubRepoLicense: GitHubRepoLicense = {
  ...
  git_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/git/blobs/8dada3edaf50dbc082c9a125058f25def75e625a',
...
export const expectedGitHubRepoCommit: GitHubRepoCommit = {
  ...
  commit: {
    ...
    tree: {
      ...
      url:
        'https://api.github.com/repos/fabric8-services/fabric8-wit/git/trees/63d68360bab70fc7e9f74544fd9c358b4ef97567',
    },
    url:
      'https://api.github.com/repos/fabric8-services/fabric8-wit/git/commits/225368a414f88bd3c45fd686496a924a15ef81b0',
    comment_count: 0,
  },
  url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/commits/225368a414f88bd3c45fd686496a924a15ef81b0',
  html_url:
    'https://github.com/fabric8-services/fabric8-wit/commit/225368a414f88bd3c45fd686496a924a15ef81b0',
  comments_url:
    'https://api.github.com/repos/fabric8-services/fabric8-wit/commits/225368a414f88bd3c45fd686496a924a15ef81b0/comments',
  author: {
    login: 'alexeykazakov',
    id: 620087,
  ...
  parents: [
    {
      ...
      url:
        'https://api.github.com/repos/fabric8-services/fabric8-wit/commits/8d91e778ab952edbeb983018e3e501ead726003d',
      html_url:
        'https://github.com/fabric8-services/fabric8-wit/commit/8d91e778ab952edbeb983018e3e501ead726003d',
    },
  ],
  stats: {
    total: 5,
  ...
  files: [
    {
      ...
      changes: 5,
      blob_url:
        'https://github.com/fabric8-services/fabric8-wit/blob/225368a414f88bd3c45fd686496a924a15ef81b0/openshift/core.app.yaml',
      raw_url:
        'https://github.com/fabric8-services/fabric8-wit/raw/225368a414f88bd3c45fd686496a924a15ef81b0/openshift/core.app.yaml',
      contents_url:
        'https://api.github.com/repos/fabric8-services/fabric8-wit/contents/openshift/core.app.yaml?ref=225368a414f88bd3c45fd686496a924a15ef81b0',
      patch:
